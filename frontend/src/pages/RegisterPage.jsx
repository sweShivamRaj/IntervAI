...
export default function RegisterPage() {
  ...
  return (
    <AuthShell
      ...
      footer={<>Already have an account? <Link className="font-bold text-accent-dark hover:underline" to="/login">Sign in <Icon name="arrow" size={14} className="inline" /></Link></>}
    >
      <form onSubmit={onSubmit} className="space-y-4" noValidate>
        ...
        <button type="submit" className="btn-primary mt-2 w-full py-3" disabled={busy}>
